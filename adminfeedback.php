...
<html lang="en">
<head>
<title>Nilai FOS |Admin Panel</title>
<meta charset="utf-8">
...
if(isset($_REQUEST['Name']) && isset($_REQUEST['No']))
	...
	$Nu=$_REQUEST['No'];
	  ...
	  $results = $mysqli->query("SELECT * from feedback order by SNo DESC");
...
?>
	...
	<td><textarea rows="3" cols="25"><?php echo $obj->Message; ?></textarea></td>
	</tr>
<?php
 $count++;
	}//while ends here
