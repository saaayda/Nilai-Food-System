...
<!DOCTYPE html>
<html lang="en">
<title>Pizza Encik Berahim | Menu</title>
	...
	<div class="main zerogrid">
		<article id="content2">
						...
						<h2>Our Location</h2>
													 ...
													 Ground Level<br> Bangunan Haji Mahmud, Taman Semarak, Semarak, Nilai<br>
              							
							<iframe src="https://www.google.com/maps/embed/v1/view?key=AIzaSyAUhxYepR8s5xcQqGKHrtY6ChfX5VbbTmA&center=2.831173,101.788053&zoom=14&maptype=satellite" width="950" height="200" frameborder="0" style="border:0"></iframe>
							<br>
							<br>
...
<div class="body3">
		<div class="main zerogrid">
				<article id="content2">
					...
					<h2>Pizza Encik Berahim [ Menu List ]</h2>
					<div class="wrapper">

							<figure class="pad_bot1"><img src="images/pizza2.png" alt=""></figure>
							<!--Adam gives you multiple option of food delivery. We deliver the food to your Home or you can take it away from us.
							--><ul class="price">
								<li><a href="pizza.php?list=8&mid=3">Pizza (Personal)</a><span></span></li>
								<li><a href="pizza.php?list=9&mid=3">Pizza (Medium)</a><span></span></li>
								<li><a href="pizza.php?list=10&mid=3">Pizza (Large)</a><span></span></li>
								<li><a href="pizza.php?list=11&mid=3">Drinks</a><span></span></li>
					...
					<h2 align="center">
					<?php
					if($_REQUEST["list"]==8) echo '<img src="images/pizza/pzz1.jpg" height="100" width="100" alt="">&raquo;Pizza (Personal)';
					if($_REQUEST["list"]==9) echo '<img src="images/pizza/pzz2.jpg" height="100" width="100" alt="">&raquo;Pizza (Medium)';
					if($_REQUEST["list"]==10) echo '<img src="images/pizza/pzz3.jpg" height="100" width="100" alt="">&raquo;Pizza (Large)';
					if($_REQUEST["list"]==11) echo '<img src="" height="100" width="100" alt="">&raquo;Drinks';
