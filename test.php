...
<div id="customer">
  ...
  $message .= "<tr><td><img src='images/logo.jpg' alt='Nilai FOS' /></td></tr>";
  $message .= "<tr><td>Dear Nilai FOS,<br /><br />Congratulation ! You got a new order. For more details click <a href=''>here</a></td></tr>";
	...
	echo '<ul>';
		...
		$result_order=$mysqli->query("Insert into orders values('$d','$name','$No','$ord','$ordprodqty','$ordprodprice')");
		  ...
		  <tr>
		      ...
		      <td class="total-value"><textarea id="paid"><?php echo $dc=($total<300)? 2.00 : "NIL" ?></textarea></td>
		  </tr>
		  <tr>
		      <td colspan="2" class="blank"> </td>
...
$message .="<tr>
	  ...
	  $total = 0;	
  $message .= "<tr><td font='colr:#999999;'><I>nilaiFOS.com<br>. :)</I></td></tr>"; 
  $message .= "</table>";
  $message .= "</body></html>";
  $subject="New Order";
...
$to   = $_REQUEST["em"];
 ...
 // $headers .= "Reply-To: ". strip_tags($from) . "\r\n";
  ...
  $message .= '<table width="100%"; rules="all" style="border:1px solid #3A5896;" cellpadding="10">';
  $message .= "<tr><td><img src='images/logo.jpg' alt='Nilai FOS' /></td></tr>";
  $message .= "<tr><td colspan=2>Dear $name,<br /><br />We thank you for ordering from our Nilai FOS Website. We also provide Hall for party and catering service. For more details click <a href=''>here</a></td></tr>";
  $message .= "<tr><td colspan=2 font='colr:#999999;'><I>NilaiFOS.com<br>Thanks For the visit.Please visit Again. :)</I></td></tr>"; 
  $message .= "</table>";
  $message .= "</body></html>";
...
<!-- footer -->
		 <center> <h5>Thank You  !</h5></center>
		  ...
		  <!--<textarea>&copy;CNilai FOS              Developed by:Saydatul Zulkipli</textarea>-->
		<!-- / footer -->
