 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<br><br>
			        ...
			        <div id="kcontent">
            <h1><h1 style="width:100%;"> Nilai FOS Payment Method</h1>
            <div id="wwrapper">
                <div id="steps">
...
if(isset($_SESSION["cart_session"]))
{
    ...
    echo ' <p> <label for="Address">Total Amount:</label> <input id="paid" class="tAmount" name="Total"  value=" '.$currency.$total.'"  type="text"  disabled></p>';
