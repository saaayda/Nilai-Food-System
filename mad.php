...
<!DOCTYPE html>
<html lang="en">
<title>Pak Mat Masakan Panas | Menu</title>
	...
	<div class="main zerogrid">
		<article id="content2">
						...
						<h2>Our Location</h2>
							...
							Cafateria<br> Kolej Kediaman Nilam Court, Nilai Impian, 71800 Bandar Baru Nilai<br>
...
<div class="body3">
		<div class="main zerogrid">
				<article id="content2">
					...
					<h2>Pak Mat Masakan Panas [ Menu List ]</h2>
					<div class="wrapper">

							<figure class="pad_bot1"><img src="images/mad2.png" alt=""></figure>
							<!--Adam gives you multiple option of food delivery. We deliver the food to your Home or you can take it away from us.
							--><ul class="price">
								<li><a href="mad.php?list=18&mid=3">Sup Panas</a><span></span></li>
								<li><a href="mad.php?list=16&mid=3">Kuey Teow</a><span></span></li>
								<li><a href="mad.php?list=17&mid=3">Mee Goreng</a><span></span></li>
								<li><a href="mad.php?list=2&mid=3">Nasi Goreng</a><span></span></li>
								<li><a href="mad.php?list=1&mid=3">Lain-Lain</a><span></span></li>
								<li><a href="mad.php?list=6&mid=3">Air (Sejuk)</a><span></span></li>
								<li><a href="mad.php?list=7&mid=3">Jus Buah</a><span></span></li>
					...
					<h2 align="center">
					<?php
					if($_REQUEST["list"]==18) echo '<img src="images/adam/ngusa.jpg" height="100" width="100" alt="">&raquo;Sup Panas ';
					if($_REQUEST["list"]==16) echo '<img src="images/chemburi/sizzlers.jpg" height="100" width="100" alt="">&raquo;Kuey Teow ';
					if($_REQUEST["list"]==17) echo '<img src="images/chemburi/shanghai.jpg" height="100" width="100" alt="">&raquo;Mee Goreng ';
					if($_REQUEST["list"]==2) echo '<img src="" height="100" width="100" alt="">&raquo;Nasi Goreng ';
