...
<!DOCTYPE html>
<html lang="en">
<title>Pasta Muchos Restaurant| Menu</title>
	...
	<div class="main zerogrid">
		<article id="content2">
						...
						<h2>Our Location</h2>
													 ...
													 Lot 71<br>Bangunan Nilai Baru, Jalan BBN 2/6, 71800 Bandar Baru Nilai<br>
...
<div class="body3">
		<div class="main zerogrid">
				<article id="content2">
					...
					<h2>Pasta Muchos Restaurant[ Menu List ]</h2>
					<div class="wrapper">

							<figure class="pad_bot1"><img src="images/pasta2.png" alt=""></figure>
							<!--Adam gives you multiple option of food delivery. We deliver the food to your Home or you can take it away from us.
							--><ul class="price">
								<li><a href="pasta.php?list=12&mid=3">Pasta</a><span></span></li>
								<li><a href="pasta.php?list=11&mid=3">Drinks</a><span></span></li>
						</div></div>
							</ul>
						</div></div>
					<h2 align="center">
					...
					<?php
					if($_REQUEST["list"]==12) echo '<img src="images/pasta/pss1.jpg" height="100" width="100" alt="">&raquo;Pasta ';
