...
<!DOCTYPE html>
<html lang="en">
<title>Adam Western Seafood | Menu</title>
	...
	<div class="main zerogrid">
		<article id="content2">
						...
						<h2>Our Location</h2>
													 ...
													 Ground Level<br> Kolej Kediaman Acacia, Bandar Baru Nilai<br>
...
<div class="body3">
		<div class="main zerogrid">
				<article id="content2">
					...
					<h2>Adam Western Seafood [ Menu List ]</h2>
					<div class="wrapper">

							<figure class="pad_bot1"><img src="images/adam2.jpg" alt=""></figure>
							<!--Adam gives you multiple option of food delivery. We deliver the food to your Home or you can take it away from us.
							--><ul class="price">
								<li><a href="adam.php?list=2&mid=3">Nasi Goreng</a><span></span></li>
								<li><a href="adam.php?list=3&mid=3">Tomyam</a><span></span></li>
								<li><a href="adam.php?list=4&mid=3">Ayam / Daging</a><span></span></li>
								<li><a href="adam.php?list=5&mid=3">Sotong / Udang</a><span></span></li>
								<li><a href="adam.php?list=1&mid=3">Lain-Lain</a><span></span></li>
								<li><a href="adam.php?list=6&mid=3">Air (Sejuk)</a><span></span></li>
								<li><a href="adam.php?list=7&mid=3">Jus Buah</a><span></span></li>
					...
					if($_REQUEST["list"]==3) echo '<img src="images/adam/tseafood.jpg" height="100" width="100" alt="">&raquo;Tomyam ';
