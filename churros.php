...
<!DOCTYPE html>
<html lang="en">
<title>Churros Restaurant | Menu</title>
	...
	<div class="main zerogrid">
		<article id="content2">
						...
						<h2>Our Location</h2>
													 ...
													 Ground Level<br>Bangunan Yeay, Nilai 7<br>
		...
		<div class="main zerogrid">
				<article id="content2">
					...
					<div class="wrapper">
							...
							<figure class="pad_bot1"><img src="images/churros2.png" alt=""></figure>
							<!--Adam gives you multiple option of food delivery. We deliver the food to your Home or you can take it away from us.
							--><ul class="price">
								<li><a href="churros.php?list=15&mid=3">Churros</a><span></span></li>
								<li><a href="churros.php?list=11&mid=3">Drinks</a><span></span></li>
						</div></div>
							</ul>
						</div></div>
					<h2 align="center">
					...
					<?php
					if($_REQUEST["list"]==15) echo '<img src="img src="images/churros/dss1.jpg" height="100" width="100" alt="">&raquo;Pasta ';
